...
export default function Login () {
    ...
    const submit = async() => {
        ...
        setLoader(true);
        const response = await api("auht/login", data);
        setLoader(false);

        alert_msg('You are logged in successfully .');
            ...
            <main className='flex justify-center items-center cursor-default'>
                {
                    ...
                    <div className="log-form panel p-6 w-full sm:w-[27rem]">
                        ...
                        <form onSubmit={(e) => { e.preventDefault(); submit(); }} className="w-full space-y-5 my-5">
                            ...
                            <div className="w-full flex justify-start items-center pt-2 pb-1 select-none">
                        ...
                        <div className="space-y-3 pt-3 pb-2 select-none">
                            ...
                            <p className="w-full flex justify-center items-center gap-2 text-[.9rem] text-gray-600 tracking-wide font-semibold">
                                ...
                                <Link href="/auth/recovery" className='text-primary hover:opacity-[.8] hover:underline duration-300'>
