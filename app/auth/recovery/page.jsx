...
export default function Recovery () {
    ...
    const submit = async() => {
        ...
        setLoader(true);
        const response = await api("auht/recovery", data);
        setLoader(false);

        alert_msg('E-mail sent successfully .');
            ...
            <main className='flex justify-center items-center cursor-default'>
                {
                    ...
                    <div className="log-form panel p-6 w-full sm:w-[27rem]">
                        ...
                        <div className="flex justify-center items-center flex-col gap-2">
                            ...
                            <div className='text-[1.3rem] font-bold text-primary tracking-wide'>
                                Recovery
                            </div>

                        </div>

                        <form onSubmit={(e) => { e.preventDefault(); submit(); }} className="w-full space-y-6 mt-6 mb-4">
                        ...
                        <div className="space-y-3 py-4 select-none">
